...
namespace Bll.Interfaces
{
    public interface IProductService
    {
        ...
        /// <summary>
        ///  Return a list matches section name and pagination
        /// </summary>
        /// <param name="searchView"></param>
        /// <returns></returns>
        ICollection<Product> GetProductBySection(string section, SearchViewModel searchView);
        ...
        /// <param name="entityToUpdate"></param>
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> CreateAsync(Product entityToCreate);
    }
}
